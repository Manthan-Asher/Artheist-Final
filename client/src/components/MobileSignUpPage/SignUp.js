  ...
  return (
    <div>
      <Card
        ...
        className="signUpDialog loginCard loginCard2"
      >
        {/* <DialogTitle id="form-dialog-title">Signup Now</DialogTitle> */}
        <CardActions className="icon-button">
          <div className="google-btn-container-mobile">
            <a
              href="/auth/google"
        ...
        <CardContent>
          <hr />
          <CardContent className="cardContent">OR</CardContent>
        ...
        <CardActions className="cardButtons2">
          <Button
            onClick={handleClose}
            variant="contained"
