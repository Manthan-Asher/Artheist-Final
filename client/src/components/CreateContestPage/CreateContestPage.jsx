...
const CreateContestPage = () => {
    return (
        <div className="createContestPageBg"> 
            <div className="createContestPageContainer">
                ...
                by showcasing it to a digital audience, giving them the praise and respect they truly deserve.</p>
                <a 
                href="https://docs.google.com/forms/d/e/1FAIpQLSc62VHZuzT0sFZ_MmuksRmU6ZdRmOt8YVbSu_yKjpboiRC6MA/viewform?usp=sf_link">
                    Create Contest
                </a>
            </div>
        </div>
