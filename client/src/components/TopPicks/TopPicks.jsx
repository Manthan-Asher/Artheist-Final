  ...
  render() {
    return (
      <div className="contain">
        ...
        <p>
          Inspired by <a href="https://twitter.com/Eli_White">Eli White's</a>{" "}
          article{" "}
          <a href="http://eng.wealthfront.com/2015/06/implementing-netflix-redesign.html">
            Performant CSS Animations: Netflix Case Study
          </a>
          , his{" "}
          <a href="https://codepen.io/TheSavior/pen/LVeYBp">example pen</a>, and{" "}
          <a href="http://matthewjamestaylor.com/">Matt Taylor's</a>{" "}
          <a href="https://codepen.io/mattjamestaylor/pen/dodYPr">
            CSS-only version.
          </a>
        </p>
